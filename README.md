...
<h1 align="center">¿Cómo lo hice? 🤔</h1>
<p align="justify">
1. Elección de librería de web scraping.
2. Estudio de la estructura HTML de dichas páginas.
...
🐼 **Pandas**: Librería de Python utilizada para la creación de DataFrames y exportación/lectura de archivos.

💻 **Selenium**: Librería de Python utilizada para la extracción de información.
</p>
